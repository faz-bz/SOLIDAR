...
const QString BITCOIN_IPC_PREFIX("worldleadcurrency:");
...
{
    QString name("WorldleadcurrencyQt");
...
PaymentServer::PaymentServer(QApplication* parent) : QObject(parent), saveURIs(true)
{
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start worldleadcurrency: click-to-pay handler");
    else
...
{
    // clicking on worldleadcurrency: URLs creates FileOpen events on the Mac:
