...
const QString BITCOIN_IPC_PREFIX("solidar:");
...
PaymentServer::PaymentServer(QApplication* parent) : QObject(parent), saveURIs(true)
{
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start solidar: click-to-pay handler");
    else
...
{
    // clicking on solidar: URLs creates FileOpen events on the Mac:
